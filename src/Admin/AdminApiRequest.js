        ...
        <div className="use_sch_total_w-yellow">
            <div className="use_sch_total-yellow">
              <div className="use_input_wrap-yellow">
                ...
                />
                <a onClick={(e) => searchNeedRequest(e)} className="use_btn_sch-yellow" id="submit">
            ...
            <ul class="st_tb_col-yellow">
              ...
              {needRequestList.map((needRequest, index) => (
                <li class="tr" key={index}>
                  ...
                  <div
                    class="td-tit"
                    onClick={() => handleNeedRequestClick(needRequest)}
                    style={{ cursor: "pointer", textDecoration: "underline" }}
                  >
                    {needRequest.apinm}
                  </div>
                  <div class="td-writer">{needRequest.rqrditemnm}</div>
                  <div class="td-writer">{needRequest.rqrdrqstnm}</div>
                  <div class="td-num">{needRequest.sort}</div>
                </li>
              ))}
            </ul>
          </div>
